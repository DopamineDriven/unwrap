...
export namespace Unwrap {
 export declare module UnwrapJS {
    ...
    export const ExtendJSXIntrinsicElementsRequired: (props: typeof JsxIntrisnicElementsRequired[keyof typeof JsxIntrisnicElementsRequired]) => typeof props
    export type ExtendJSXIntrinsicElementsRequiredReturnType = ReturnType<typeof ExtendJSXIntrinsicElementsRequired extends infer U ? U : typeof ExtendJSXIntrinsicElementsRequired>;
    ...
    const DOMAttribsJSHelper: (
      { ...props }: ReturnType<typeof import("unwrap").DOMAttributesUnwrapped>
    ) => typeof props

    const ElementHelper: ReturnType<typeof ExtendJSXIntrinsicElementsRequired>;

    const pickType: Required<Pick<typeof ElementHelper, `${keyof typeof ElementHelper}`>>

    const JSHelperPickElement: (props: Pick<typeof pickType, keyof typeof pickType>) => typeof props;

    const JSHelperElementProperties: ({ ...props }: typeof JSHelperPickElement) => typeof props
